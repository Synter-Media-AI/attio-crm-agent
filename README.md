...
Manage Attio CRM data and audience exports with AI agents via MCP.

 `attio` `crm` `modern-crm` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage Attio CRM — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> Create a list for outbound

> Export people to Google Customer Match

> Add notes with attribution data
...
2. Click "Connect" next to Attio CRM
